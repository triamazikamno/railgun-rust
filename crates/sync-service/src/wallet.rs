...
pub(crate) async fn refresh_wallet_poi_statuses(
    ...
    refresh_wallet_poi_statuses_selected(
        ...
        active_list_keys,
        wallet_utxos,
        WalletPoiRefreshSelection::AllUnspent,
    )
    .await
}
...
mod tests {
    use super::{
        ...
        WalletPersistState, WalletPoiRefreshSelection, WalletProgressPersist,
