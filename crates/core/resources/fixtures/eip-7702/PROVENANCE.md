...
| Package encryption/decryption and legacy absent/COMMON behavior | The static encryption assertion in the test above; existing `strict_tx7702_encryption_roundtrips_exact_plaintext_and_dispatches_strictly` and `legacy_absent_and_common_requests_keep_legacy_decrypt_and_dispatch_behavior` |
